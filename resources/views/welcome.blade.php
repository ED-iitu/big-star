                    ...
                    @if(count($videos) > 0)
                        @foreach($videos as $video)
                            <div class="col-lg-6 col-md-6 portfolio-item {{$video->type ?? '.filter-app'}}">
                                <iframe width="500" height="300" src="{{$video->link}}" title="{{$video->title}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        @endforeach
                    @endif
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="info-box">
                                    ...
                                    <p>
                                        ...
                                        <strong>Филиал в г.Астана,</strong> ул.Иманова 19, Деловой Дом "Алматы", 10 этаж, № 1012 офис. Тел: +7 747 602 14 03<br>
                                        <strong>Филиал в г.Шымкент,</strong> 18 микрорайон, 23 дом. Тел: +7 705 507 18 32<br>
                                        ...
                                        <strong>Филиал в г.Актобе,</strong> БЦ "Мир", ул.Абилхаир Хана 85, 4 этаж, № 411 офис. Тел: +7 701 156 26 20, +7 707 892 50 25<br>
                                        <strong>Филиал в г.Семей,</strong> ул.Шакарима 67/1, БЦ "Достык". Тел: +7 777 709 13 67, +7 747 270 02 45<br>
